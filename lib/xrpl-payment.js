...
function formatResult(result, wallet, destAddress, sendMaxCurrency, destCurrency, pathSource) {
...
export async function sendPayment(senderSeed, destAddress, amount, destCurrency, sendMaxCurrency) {
  ...
  if (sendMaxCurrency === destCurrency) {
    ...
    return formatResult(result, wallet, destAddress, sendMaxCurrency, destCurrency, 'direct');
  }
  ...
  if (pathData) {
    ...
    try {
      ...
      if (result.result.meta.TransactionResult === 'tesSUCCESS') {
        return formatResult(result, wallet, destAddress, sendMaxCurrency, destCurrency, 'pathfind-amm');
      }
  ...
  return formatResult(result, wallet, destAddress, sendMaxCurrency, destCurrency, 'manual-bridge');
}
